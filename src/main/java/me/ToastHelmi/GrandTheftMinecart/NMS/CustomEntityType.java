...
public enum CustomEntityType {
	...
	ZOMBIE("Zombie", 54, EntityType.ZOMBIE, EntityZombie.class, PoliceOfficer.class), SKELETON("Skeleton", 51,
			EntityType.SKELETON, EntitySkeleton.class,
			Sniper.class), SWAT("PigZombie", 57, EntityType.PIG_ZOMBIE, EntityPigZombie.class, Swat.class);
	...
	private static void a(Class paramClass, String paramString, int paramInt) {
		try {
			...
			Bukkit.getLogger().log(Level.WARNING,
					paramString + " : " + paramClass.getSimpleName() + " is unable to register");
		}
	}
